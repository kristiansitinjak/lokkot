...
<div class="container">
    ...
    <form action="{{ route('proker.update', $proker) }}" method="POST">
        ...
        <div class="form-group mb-3">
            <label>Tujuan</label>
            <textarea name="tujuan" class="form-control" rows="3" required>{{ $proker->tujuan }}</textarea>
        </div>

        <div class="form-group mb-3">
            <label>Lokasi</label>
            <input type="text" name="lokasi" class="form-control" value="{{ $proker->lokasi }}" required>
        </div>
        ...
        <div class="form-group mb-3">
            ...
            <input type="text" name="sumber_dana" class="form-control" value="{{ $proker->sumber_dana }}" required>
        </div>
